...
export interface NoteOrigin {
  engine: 'gemini' | 'groq' | 'ollama' | 'llama-cpp' | 'openai-compatible' | 'offline-draft' | 'on-device' | 'australian-clinical-macro';
...
export interface GeneratedNotePayload {
  engine?: 'gemini' | 'groq' | 'ollama' | 'llama-cpp' | 'openai-compatible' | 'offline-draft' | 'on-device';
  modelId?: string;
